      ...
      <div className="mb-4 flex flex-wrap items-end justify-between gap-3">
        <div>
          <div className="flex items-center gap-2">
            ...
            <InfoTooltip text="Linha por métrica · coluna por mês. % MRR Ativado = MRR Ativado do mês ÷ MRR Criado do mês anterior × 100. % Churn Onboarding = MRR de deals em Pré-Churn/Churn/Cancelamento fechados no mês ÷ MRR criado no mês × 100." />
          </div>
        </div>
