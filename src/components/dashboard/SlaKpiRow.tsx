    ...
    <section className="space-y-3">
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-5">
        ...
        <Card
          ...
          tooltip="Média de sla_dias_real (dias na etapa, descontando 'Processo Pausado') entre todos os deals do estoque."
        ...
        <Card
          ...
          tooltip="% de deals com sla_dias_real ≤ 30 (dentro do prazo, já descontado tempo em 'Processo Pausado')."
          tone="success"
        ...
        <Card
          ...
          tooltip="% de deals com sla_dias_real > 30 (estourados, já descontado tempo em 'Processo Pausado')."
          tone="danger"
