    ...
    <section className="space-y-4">
      ...
      <div className="rounded-2xl border border-border bg-card p-4 sm:p-5 shadow-sm-soft">
        <div className="mb-4 flex items-end justify-between gap-2">
          ...
          <InfoTooltip text="Hoje o cálculo NÃO desconta o tempo em que o card morou em 'Processo Pausado' — depende de histórico de etapas que ainda não temos sincronizado." />
        </div>
